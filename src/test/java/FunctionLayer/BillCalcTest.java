...
public class BillCalcTest {
    ...
    public void testScrewsVandbraetAndStern() {
        ...
        int underSternFrontAndBack = 0;
        int underSternSides = 0;
        int overSternFront = 0;
        int overSternSides = 0;
        BillCalc instance = new BillCalc();
        int expResult = 0;
    ...
    public void testAngleBrackets() {
        ...
        int interTiesGabel = 0;
        int interTiesSides = 0;
        BillCalc instance = new BillCalc();
        int expResult = 0;
