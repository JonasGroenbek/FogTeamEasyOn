...
public class SVGBuilderTop {
    ...
    public String buildSvgTopView(SVGBuilderTop svg) {
        ...
        sb.append("<svg width=\"750\" height=\"750\" viewBox=\"0 0 ").
                append(viewboxWidth).append(" ").append(viewboxLength).append("\">\n");
        buildRectangle(svg);
        buildYArrow(svg);
        buildXArrow(svg);
        buildRafter(svg);
    ...
    private void buildXArrow(SVGBuilderTop svg) {
        ...
        sb.append("<text x=\"" + textX + "\" y=\"" + textY
    ...
    private void spacingMarkers(double spacing, SVGBuilderTop svg) {
        for (double i = 0 + spacing; i < svg.width; i += spacing + rafter) {
            ...
            sb.append("<text x=\"" + textPlacement + "\" y=\"" + textPlacementY
    ...
    private void createShed(SVGBuilderTop svg) {
        ...
        int y = firstY + roofOverhang;
        sb.append("<rect x=\"" + innerMostX + "\" y=\"" + y + "\" width=\"" +
                svg.shed.getWidth() + "\"height=\"" + svg.shed.getLength() + 
    ...
    private void createPosts(SVGBuilderTop svg) {
        ...
        if (svg.shed.getLength() > 100) {
            ...
            sb.append("<circle cx=\"" + innerMostX + "\" cy=\"" + minYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + innerMostX + "\" cy=\"" + shedLength
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + shedWidth + "\" cy=\"" + minYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + shedWidth + "\" cy=\"" + shedLength
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + middleOfShedX + "\" cy=\"" + minYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + middleOfShedX + "\" cy=\"" + shedLength
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");

            sb.append("<circle cx=\"" + innerMostX + "\" cy=\"" + maxYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + maxXMinusSpacing + "\" cy=\"" + maxYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + maxXMinusSpacing + "\" cy=\"" + minYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");

            sb.append("<line stroke-dasharray=\"5, 5, 1, 5\"  x1=\"" + shedWidth
                    + "\" y1=\"" + minYPole + "\" x2=\"" + maxXMinusSpacing + "\" y2=\"" + shedLength
                    + "\" stroke=\"#000\" stroke-width=\"2\"/> \n");
            sb.append("<line stroke-dasharray=\"5, 5, 1, 5\"  x1=\"" + maxXMinusSpacing
                    + "\" y1=\"" + minYPole + "\" x2=\"" + shedWidth + "\" y2=\"" + shedLength
                    + "\" stroke=\"#000\" stroke-width=\"2\"/> \n");
            if (svg.width > 500) {
                sb.append("<circle cx=\"" + middleOfX + "\" cy=\"" + maxYPole
                        + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            }
        } else { //setting up the poles markers, without a shed.
            double firstPoles = firstX + spacing + rafter;
            sb.append("<circle cx=\"" + firstPoles + "\" cy=\"" + maxYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + firstPoles + "\" cy=\"" + minYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + maxXMinusSpacing + "\" cy=\"" + maxYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            sb.append("<circle cx=\"" + maxXMinusSpacing + "\" cy=\"" + minYPole
                    + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            //creating 
            sb.append("<line stroke-dasharray=\"5, 5, 1, 5\"  x1=\"" + minXPlusSpacing
                    + "\" y1=\"" + minYPole + "\" x2=\"" + maxXMinusSpacing + "\" y2=\"" + maxYPole
                    + "\" stroke=\"#000\" stroke-width=\"2\"/> \n");
            sb.append("<line stroke-dasharray=\"5, 5, 1, 5\"  x1=\"" + maxXMinusSpacing
                    + "\" y1=\"" + minYPole + "\" x2=\"" + minXPlusSpacing + "\" y2=\"" + maxYPole
                    + "\" stroke=\"#000\" stroke-width=\"2\"/> \n");
            if (svg.width > 500) {
                sb.append("<circle cx=\"" + middleOfX + "\" cy=\"" + maxYPole
                        + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
                sb.append("<circle cx=\"" + middleOfX + "\" cy=\"" + minYPole
                        + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            }
            if (svg.length > 500) {
                sb.append("<circle cx=\"" + firstPoles + "\" cy=\"" + middleOfY
                        + "\" r=\"4\" stroke=\"black\" stroke-width=\"1\" fill=\"white\"/>");
            }
        }
    }
