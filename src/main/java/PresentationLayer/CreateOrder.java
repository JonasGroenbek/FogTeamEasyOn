...
public class CreateOrder extends Command {
    ...
    String execute(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            bom.add(tiesgabled);
            int tiessides = calc.interTiesShedSides(widthShed);
            bom.add(tiessides);
            ...
            session.setAttribute("SVGTopView", new SVGBuilderTop(roof, length, width, shed, material));
            session.setAttribute("SVGSideView", new SVGBuilderSide(roof, length, width, shed, material));
